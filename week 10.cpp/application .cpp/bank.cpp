...
int main()
{
    ...
    int choice, password, account_number, deposit_amount, withdraw_amount;
    string name;
    ...
    while (true)
    {
        ...
        else if (choice == 1)
        {
            ...
            if (userIndex != -1)
            {
                ...
                balances[userIndex] = balances[userIndex] + deposit_amount;
        ...
        else if (choice == 2)
        {
            ...
            if (userIndex != -1)
            {
                ...
                {
                    balances[userIndex] = balances[userIndex] - withdraw_amount;
        ...
        else if (choice == 5)
        {
            ...
            if (userIndex != -1)
            {
                ...
                {
                    balances[userIndex] = balances[userIndex] - transfer_amount;
                    balances[receiver] = balances[receiver] + transfer_amount;
        ...
        else if (choice == 7)
        {
            ...
            if (userIndex != -1)
            {
                ...
                {
                    balances[userIndex] = balances[userIndex] + loan_amount;
